...
## Read in 2019 High School Completion dataset.

```{r}
url <- "https://reportcard.msde.maryland.gov/DataDownloads/FileDownload/403"
download.file(url, "2019_High_School_Completion.zip")
unzip("2019_High_School_Completion.zip")
HS_Completion19 <- read.csv("2019_High_School_Completion.csv")
